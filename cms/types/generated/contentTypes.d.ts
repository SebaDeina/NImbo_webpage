...
export interface ApiContactoContacto extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Consultas enviadas desde el formulario de contacto';
  ...
  attributes: {
    ...
    lang: Schema.Attribute.Enumeration<['es', 'en']> &
...
export interface ApiProyectoProyecto extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Trabajos del portfolio de NIMBO';
  ...
  attributes: {
    accent: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#6665ff'>;
    ...
    > &
      Schema.Attribute.Private;
    placeholder: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
